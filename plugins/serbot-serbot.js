...
let pathYukiJadiBot = path.join(`./YukiJadibot/`, id)
...
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['Mafia (Sub Bot)', 'Chrome','2.0.0'],
