...
export async function before(m, {conn, participants, groupMetadata}) {
  ...
  let pp = await conn.profilePictureUrl(m.messageStubParameters[0], 'image').catch(_ => 'https://files.catbox.moe/2yrug6.jpg')
