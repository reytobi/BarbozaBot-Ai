...
const rwait = '⏳'; // Emoji para espera
const done = '✅'; // Emoji para indicar que está hecho
const dev = 'Tu mensaje aquí'; // Define lo que necesites para dev
const wm = 'Tu watermark aquí'; // Define lo que necesites para wm
