...
🍬 *Dulces añadidos:* 10
    ...
    // Agregar el botón de menú
    const menuButton = {
        buttonText: {
            displayText: '.menu'
        },
        type: 1,
        url: 'https://f.uguu.se/TQHDjOFW.jpg' // Cambia esto por la URL o mensaje que quieras enviar como menú.
    };
    ...
    await conn.sendMessage(m.chat, { 
        ...
        caption: regbot,
        buttons: [menuButton],
        footer: 'Presiona el botón para ver el menú.'
    }, { quoted: m })
}
